...
- *#link("https://github.com/hackclub/ai")[ai.hackclub.com]:* (Rust, Actix, Groq) Created a free OpenAI-schema-compatible `/chat/completions` service; \~0.5B tokens processed since Jan 2025.
