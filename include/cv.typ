...
#work(
  ...
  location: "England",
  company: "Freelance",
  dates: dates-helper(start-date: "March 2020", end-date: "Jan 2021"),
)
...
== Talks
- *RailsConf* — "Raytracing In ActiveRecord" #h(1fr)
- *MIT Blueprint* — "How We Built The Largest Online Hackathon Ever" #h(1fr)
- *Congressional App Challenge, US Capitol* — "How To Ship Real Projects With AI" #h(1fr)
