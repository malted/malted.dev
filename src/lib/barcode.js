...
!(function (t) {
	...
	function (t, e, n) {
		...
		var c = (function (t) {
			function e() {
				return (
					u(this, e), f(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
				);
			}
			return (
				(function (t, e) {
		...
		var d = function () {},
			h = function (t, e, n) {
				...
				return (
					...
					void 0 !== e &&
						((n = n || {}).format || (n.format = _()), r.options(n)[n.format](e, n).render()),
					r
				);
			};
	...
	function (t, e, n) {
		...
		function f(t) {
			...
			if ("undefined" != typeof HTMLCanvasElement && t instanceof HTMLCanvasElement)
				return { element: t, options: (0, o.default)(t), renderer: i.default.CanvasRenderer };
								...
								for (var i = 0, a = 0, u = 0; u < o.length; u++)
									(a = u * e.width + n.barcodePadding),
										"1" === o[u]
											? i++
											: i > 0 &&
											  (this.drawRect(a - e.width * i, r, e.width * i, e.height, t), (i = 0));
